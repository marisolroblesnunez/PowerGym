<?php
// Este archivo PHP es responsable de mostrar la lista de clases disponibles en el gimnasio.
// Permite a los usuarios ver las clases, filtrarlas por día de la semana y, si hay cupo,
// les ofrece la opción de inscribirse en una clase específica. Obtiene los datos de las clases
// a través del `ClaseController`.
