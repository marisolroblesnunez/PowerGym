<?php
// Este archivo PHP maneja el proceso de inscripción de un usuario a una clase específica.
// Recibe el ID de la clase, procesa la solicitud de inscripción a través del `InscripcionController`,
// y muestra un mensaje al usuario indicando si la inscripción fue exitosa o si hubo algún error.
